...
import { register, login, refreshAccessToken, logout, forgotPassword, verifyResetOtp, resetPassword, resendResetOtp } from "../controller/AuthController.js";
import { loginRateLimiter } from "../middleware/rateLimiter.js";
import { validateBody } from "../middleware/validate.js";
import { loginSchema, registerSchema, emailOnlySchema, verifyResetOtpSchema, resetPasswordSchema } from "../validation/authValidation.js";
const router = Router();
