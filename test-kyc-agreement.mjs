...
async function test() {
  try {
    /*
     * Temporary test signature.
     *
     * Create any small PNG signature image and put it here:
     *
     * documents/kyc/test-signature.png
     */
    ...
    const result = await generateSignedKycAgreement({
